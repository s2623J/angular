...
describe('MemberListComponent', () => {
  ...
  describe('viewed by the event creator', () => {
    ...
    it('should display the event creator in the member list', () => {
      const members = fixture.debugElement.queryAll(By.css('li.list-group-item'));
      expect(members[0].nativeElement.innerText).toEqual('newUser');
    })
  })
  ...
  fdescribe('viewed by a non-event creator', () => {
    ...
    it('should update the member list when the subscriber button is pressed', () => {
      spyOn(eventsService, 'subscribe').and.callFake(() => of(updatedEvent));
      component.members = updatedEvent.members; // Spy alone will not allow component to update members
      const subscribeBtn = fixture.debugElement.query(By.css('[data-test=subscribe]'))
      ...
      expect(members[1].nativeElement.innerText).toEqual('adam');
    })

    it('should show an error if the subscribe fails', () => {
      ...
      fixture.debugElement.query(By.css('[data-test=subscribe]'))
        .nativeElement.click();
      fixture.detectChanges();
      ...
      const errorMessage = fixture.debugElement
        .query(By.css('.alert-danger')).nativeElement.innerText;
      expect(errorMessage).toEqual('Something went wrong. Try again.')
    })
  })
});
