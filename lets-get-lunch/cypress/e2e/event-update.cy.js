describe('Event Update', () => {
  ...
  it('should redirect to the event update page when the edit' + 
    ' link is clicked', () => {
      cy
        .get('.event-edit').should('have.text', 'Edit').click()
        .url().should('include', '/update')
  })
  
  it('should display a success message for an even that has been' + 
